...
export class MemberApi extends BaseLoopBackApi {
   ...
   * @param {any} id Member id
   *
   * @param {any} fk Foreign key for topics
   *
   * @returns {object} An empty reference that will be
   *   populated with the actual data once the response is returned
   *   from the server.
   ...
   * </em>
   */
  public findByIdTopics(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * This method returns no data.
   */
  public destroyByIdTopics(id: any, fk: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Members/:id/topics/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public updateByIdTopics(id: any, fk: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "PUT";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Members/:id/topics/:fk";
    let _routeParams: any = {
   ...
   * </em>
   */
  public getTopics(id: any, filter: LoopBackFilter = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Members/:id/topics";
    let _routeParams: any = {
   ...
   * </em>
   */
  public createTopics(id: any, data: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Members/:id/topics";
    let _routeParams: any = {
   ...
   * This method returns no data.
   */
  public deleteTopics(id: any, customHeaders?: Function): Observable<any> {
    let _method: string = "DELETE";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Members/:id/topics";
    let _routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countTopics(id: any, where: any = {}, customHeaders?: Function): Observable<any> {
    let _method: string = "GET";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
  ...
  /**
   * Statistical information for Member registers.
   *
   ...
   * </em>
   */
  public createManyTopics(id: any, data: any[] = [], customHeaders?: Function): Observable<any> {
    let _method: string = "POST";
    let _url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Members/:id/topics";
    let _routeParams: any = {
