...
export class BlockApi extends BaseLoopBackApi {
  ...
  /**
   * Fetches belongsTo relation blockContent.
   *
   ...
   * </em>
   */
  public getBlockContent(id: any, refresh: any = {}, customHeaders?: Function): Observable<any> {
  ...
  /**
   * Statistical information for Block registers.
   *
